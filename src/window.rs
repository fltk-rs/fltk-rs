...
impl WidgetTrait for Window {
    ...
    fn tooltip(&self) -> ffi::CString {
        unsafe {
            ffi::CString::from_raw(
                fltk_sys::window::Fl_Window_tooltip(self._inner) as *mut libc::c_char
            )
        }
    }
    ...
    fn get_type<T: WidgetType>(&self) -> T {
        unsafe { T::from_i32(fltk_sys::window::Fl_Window_get_type(self._inner)) }
    }
    ...
    fn color(&self) -> Color {
        unsafe { mem::transmute(fltk_sys::window::Fl_Window_color(self._inner)) }
    }

    fn set_color(&mut self, color: Color) {
        unsafe { fltk_sys::window::Fl_Window_set_color(self._inner, color as i32) }
    }

    fn label_color(&self) -> Color {
        unsafe { mem::transmute(fltk_sys::window::Fl_Window_label_color(self._inner)) }
    }

    fn set_label_color(&mut self, color: Color) {
        unsafe { fltk_sys::window::Fl_Window_set_label_color(self._inner, color as i32) }
    }

    fn label_font(&self) -> Font {
        unsafe { mem::transmute(fltk_sys::window::Fl_Window_label_font(self._inner)) }
    }

    fn set_label_font(&mut self, font: Font) {
        unsafe { fltk_sys::window::Fl_Window_set_label_color(self._inner, font as i32) }
    }

    fn label_size(&self) -> usize {
        unsafe { fltk_sys::window::Fl_Window_label_size(self._inner) as usize }
    }

    fn set_label_size(&mut self, sz: usize) {
        unsafe { fltk_sys::window::Fl_Window_set_label_size(self._inner, sz as i32) }
    }

    fn label_type<T: WidgetType>(&self) -> T {
        unsafe { T::from_i32(fltk_sys::window::Fl_Window_label_type(self._inner)) }
    }
    ...
    fn get_box<T: WidgetType>(&self) -> T {
        unsafe { T::from_i32(fltk_sys::window::Fl_Window_box(self._inner)) }
    }

    fn set_box<T: WidgetType>(&mut self, typ: T) {
        unsafe {
            fltk_sys::window::Fl_Window_set_box(self._inner, typ.to_int());
        }
    }
}
