...
impl Progress {
    ...
    pub fn minimum(&self) -> f64 {
        unsafe {
            Fl_Progress_minimum(self._inner)
        }
    }
    /// Sets the minimu value of the progress bar
    pub fn set_minimum(&mut self, a: f64) {
        unsafe {
            Fl_Progress_set_minimum(self._inner, a)
        }
    }
    /// Returns the maximum value of the progress bar
    pub fn maximum(&self) -> f64 {
        unsafe {
            Fl_Progress_maximum(self._inner)
        }
    }
    /// Sets the minimum value of the progress bar
    pub fn set_maximum(&mut self, a: f64) {
        unsafe {
            Fl_Progress_set_maximum(self._inner, a)
        }
    }
    /// Returns the value of the progress bar
    pub fn value(&self) -> f64 {
        unsafe {
            Fl_Progress_value(self._inner)
        }
    }
