...
impl Spinner {
    ...
    pub fn set_maximum_size(&mut self, s: u32) {
        debug_assert!(s <= std::i32::MAX as u32, "u32 entries have to be < std::i32::MAX for compatibility!");
...
impl Chart {
    ...
    pub fn set_size(&mut self, w: u32, h: u32) {
        debug_assert!(w <= std::i32::MAX as u32, "u32 entries have to be < std::i32::MAX for compatibility!");
        debug_assert!(h <= std::i32::MAX as u32, "u32 entries have to be < std::i32::MAX for compatibility!");
...
impl Tooltip {
    ...
    pub fn set_margin_width(v: u32) {
        debug_assert!(v <= std::i32::MAX as u32, "u32 entries have to be < std::i32::MAX for compatibility!");
