...
int Fl_Widget_y(Fl_Widget *self) {
    return self->y();
}

int Fl_Widget_width(Fl_Widget *self) {
    return self->w();
}

int Fl_Widget_height(Fl_Widget *self) {
    return self->h();
}

const char *Fl_Widget_label(Fl_Widget *self) {
    return self->label();
}
...
const char *Fl_Widget_tooltip(Fl_Widget *self) {
    return self->tooltip();
}
...
int Fl_Widget_get_type(Fl_Widget *self) {
    return self->type();
}
...
unsigned int Fl_Widget_color(Fl_Widget *self) {
    return self->color();
}
...
int Fl_Widget_label_font(Fl_Widget *self) {
...
int Fl_Widget_label_size(Fl_Widget *self) {
...
int Fl_Widget_label_type(Fl_Widget *self) {
...
int Fl_Widget_box(Fl_Widget *self) {
    return self->box();
}
...
int Fl_Widget_changed(Fl_Widget *self) {
    return self->changed();
}

void Fl_Widget_set_changed(Fl_Widget *self) {
    LOCK(self->set_changed();)
}

void Fl_Widget_clear_changed(Fl_Widget *self) {
    LOCK(self->clear_changed();)
}

int Fl_Widget_align(Fl_Widget *self) {
    return self->align();
}

void Fl_Widget_set_align(Fl_Widget *self, int typ) {
    LOCK(self->align(typ);)
}
...
void *Fl_Widget_window(const Fl_Widget *self) {
...
void *Fl_Widget_user_data(const Fl_Widget *self) {
