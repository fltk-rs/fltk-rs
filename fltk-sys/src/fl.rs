...
extern "C" {
    pub fn Fl_cairo_make_current(w: *mut Fl_Widget) -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn Fl_set_cairo_autolink_context(alink: ::std::os::raw::c_int);
}
extern "C" {
    pub fn Fl_cairo_autolink_context() -> ::std::os::raw::c_int;
}
extern "C" {
    pub fn Fl_cairo_cc() -> *mut ::std::os::raw::c_void;
}
extern "C" {
    pub fn Fl_set_cairo_cc(c: *mut ::std::os::raw::c_void, own: ::std::os::raw::c_int);
}
extern "C" {
