...
extern "C" {
    pub fn Fl_get_font_name(idx: libc::c_int) -> *const libc::c_char;
}
extern "C" {
    pub fn Fl_get_font_sizes(font: libc::c_int, sizep: *mut *mut libc::c_int) -> libc::c_int;
}
extern "C" {
...
extern "C" {
    pub fn Fl_add_system_handler(
        arg1: ::core::option::Option<
            unsafe extern "C" fn(arg1: *mut libc::c_void, arg2: *mut libc::c_void) -> libc::c_int,
        >,
        arg2: *mut libc::c_void,
    );
}
