...
extern "C" {
    pub fn Fl_background2(r: core::ffi::c_uchar, g: core::ffi::c_uchar, b: core::ffi::c_uchar);
}
extern "C" {
    pub fn Fl_selection_color(r: core::ffi::c_uchar, g: core::ffi::c_uchar, b: core::ffi::c_uchar);
}
extern "C" {
    pub fn Fl_inactive_color(r: core::ffi::c_uchar, g: core::ffi::c_uchar, b: core::ffi::c_uchar);
}
extern "C" {
    pub fn Fl_get_system_colors();
}
extern "C" {
    pub fn Fl_handle(arg1: core::ffi::c_int, arg2: *mut core::ffi::c_void) -> core::ffi::c_int;
}
extern "C" {
    pub fn Fl_handle_(arg1: core::ffi::c_int, arg2: *mut core::ffi::c_void) -> core::ffi::c_int;
}
extern "C" {
    pub fn Fl_add_idle(
        arg1: ::core::option::Option<unsafe extern "C" fn(arg1: *mut core::ffi::c_void)>,
