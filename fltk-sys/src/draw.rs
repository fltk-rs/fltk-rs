...
extern "C" {
    pub fn Fl_set_color_rgb(r: core::ffi::c_uchar, g: core::ffi::c_uchar, b: core::ffi::c_uchar);
}
extern "C" {
...
extern "C" {
    pub fn Fl_set_cursor2(cursor: core::ffi::c_int, fg: core::ffi::c_int, bg: core::ffi::c_int);
}
extern "C" {
...
extern "C" {
    pub fn Fl_create_offscreen(w: core::ffi::c_int, h: core::ffi::c_int) -> *mut core::ffi::c_void;
}
extern "C" {
