...
pub const FL_MAJOR_VERSION: u32 = 1;
pub const FL_MINOR_VERSION: u32 = 4;
pub const FL_PATCH_VERSION: u32 = 0;
pub const FL_API_VERSION: u32 = 10400;
pub const FL_ABI_VERSION: u32 = 10400;
pub const FL_Button: u32 = 65256;
pub const FL_BackSpace: u32 = 65288;
pub const FL_Tab: u32 = 65289;
pub const FL_Iso_Key: u32 = 65292;
pub const FL_Enter: u32 = 65293;
pub const FL_Pause: u32 = 65299;
pub const FL_Scroll_Lock: u32 = 65300;
pub const FL_Escape: u32 = 65307;
pub const FL_Kana: u32 = 65326;
pub const FL_Eisu: u32 = 65327;
pub const FL_Yen: u32 = 65328;
pub const FL_JIS_Underscore: u32 = 65329;
pub const FL_Home: u32 = 65360;
pub const FL_Left: u32 = 65361;
pub const FL_Up: u32 = 65362;
pub const FL_Right: u32 = 65363;
pub const FL_Down: u32 = 65364;
pub const FL_Page_Up: u32 = 65365;
pub const FL_Page_Down: u32 = 65366;
pub const FL_End: u32 = 65367;
pub const FL_Print: u32 = 65377;
pub const FL_Insert: u32 = 65379;
pub const FL_Menu: u32 = 65383;
pub const FL_Help: u32 = 65384;
pub const FL_Num_Lock: u32 = 65407;
pub const FL_KP: u32 = 65408;
pub const FL_KP_Enter: u32 = 65421;
pub const FL_KP_Last: u32 = 65469;
pub const FL_F: u32 = 65469;
pub const FL_F_Last: u32 = 65504;
pub const FL_Shift_L: u32 = 65505;
pub const FL_Shift_R: u32 = 65506;
pub const FL_Control_L: u32 = 65507;
pub const FL_Control_R: u32 = 65508;
pub const FL_Caps_Lock: u32 = 65509;
pub const FL_Meta_L: u32 = 65511;
pub const FL_Meta_R: u32 = 65512;
pub const FL_Alt_L: u32 = 65513;
pub const FL_Alt_R: u32 = 65514;
pub const FL_Delete: u32 = 65535;
pub const FL_Volume_Down: u32 = 61201;
pub const FL_Volume_Mute: u32 = 61202;
pub const FL_Volume_Up: u32 = 61203;
pub const FL_Media_Play: u32 = 61204;
pub const FL_Media_Stop: u32 = 61205;
pub const FL_Media_Prev: u32 = 61206;
pub const FL_Media_Next: u32 = 61207;
pub const FL_Home_Page: u32 = 61208;
pub const FL_Mail: u32 = 61209;
pub const FL_Search: u32 = 61211;
pub const FL_Back: u32 = 61222;
pub const FL_Forward: u32 = 61223;
pub const FL_Stop: u32 = 61224;
pub const FL_Refresh: u32 = 61225;
pub const FL_Sleep: u32 = 61231;
pub const FL_Favorites: u32 = 61232;
pub const FL_LEFT_MOUSE: u32 = 1;
pub const FL_MIDDLE_MOUSE: u32 = 2;
pub const FL_RIGHT_MOUSE: u32 = 3;
pub const FL_SHIFT: u32 = 65536;
pub const FL_CAPS_LOCK: u32 = 131072;
pub const FL_CTRL: u32 = 262144;
pub const FL_ALT: u32 = 524288;
pub const FL_NUM_LOCK: u32 = 1048576;
pub const FL_META: u32 = 4194304;
pub const FL_SCROLL_LOCK: u32 = 8388608;
pub const FL_BUTTON1: u32 = 16777216;
pub const FL_BUTTON2: u32 = 33554432;
pub const FL_BUTTON3: u32 = 67108864;
pub const FL_BUTTONS: u32 = 2130706432;
pub const FL_KEY_MASK: u32 = 65535;
pub const FL_NUM_FREE_COLOR: u32 = 16;
pub const FL_NUM_GRAY: u32 = 24;
pub const FL_NUM_RED: u32 = 5;
pub const FL_NUM_GREEN: u32 = 8;
pub const FL_NUM_BLUE: u32 = 5;
pub const FL_IMAGE_WITH_ALPHA: u32 = 1073741824;
...
#[doc = " Flexible length UTF-8 Unicode text."]
#[doc = ""]
#[doc = "  \\todo FIXME: temporary (?) typedef to mark UTF-8 and Unicode conversions"]
pub type Fl_String = *mut ::std::os::raw::c_char;
#[doc = " Flexible length UTF-8 Unicode read-only string."]
#[doc = "  \\sa Fl_String"]
pub type Fl_CString = *const ::std::os::raw::c_char;
#[doc = " 16-bit Unicode character + 8-bit indicator for keyboard flags."]
#[doc = ""]
#[doc = "\\note This \\b should be 24-bit Unicode character + 8-bit indicator for"]
#[doc = "keyboard flags. The upper 8 bits are currently unused but reserved."]
#[doc = ""]
#[doc = "Due to compatibility issues this type and all FLTK \\b shortcuts can only"]
#[doc = "be used with 16-bit Unicode characters (<tt>U+0000 .. U+FFFF</tt>) and"]
#[doc = "not with the full range of unicode characters (<tt>U+0000 .. U+10FFFF</tt>)."]
#[doc = ""]
#[doc = "This is caused by the bit flags \\c FL_SHIFT, \\c FL_CTRL, \\c FL_ALT, and"]
#[doc = "\\c FL_META being all in the range <tt>0x010000 .. 0x400000</tt>."]
#[doc = ""]
#[doc = "\\todo Discuss and decide whether we can \"shift\" these special keyboard"]
#[doc = "flags to the upper byte to enable full 21-bit Unicode characters"]
#[doc = "(<tt>U+0000 .. U+10FFFF</tt>) plus the keyboard indicator bits as this"]
#[doc = "was originally intended. This would be possible if we could rely on \\b all"]
#[doc = "programs being coded with symbolic names and not hard coded bit values."]
#[doc = ""]
#[doc = "\\internal Can we do the move for 1.4 or, if not, for any later version"]
#[doc = "that is allowed to break the ABI?"]
pub type Fl_Shortcut = ::std::os::raw::c_uint;
#[doc = " 24-bit Unicode character - upper 8 bits are unused"]
pub type Fl_Char = ::std::os::raw::c_uint;
pub type fl_intptr_t = ::std::os::raw::c_long;
pub type fl_uintptr_t = ::std::os::raw::c_ulong;
pub type Fl_Offscreen = ::std::os::raw::c_ulong;
pub type Fl_Bitmask = ::std::os::raw::c_ulong;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct _XRegion {
    _unused: [u8; 0],
}
pub type Fl_Region = *mut _XRegion;
pub type FL_SOCKET = ::std::os::raw::c_int;
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct __GLXcontextRec {
    _unused: [u8; 0],
}
pub type GLContext = *mut __GLXcontextRec;
...
#[doc = " No event."]
pub const Fl_Event_FL_NO_EVENT: Fl_Event = 0;
#[doc = " A mouse button has gone down with the mouse pointing at this"]
#[doc = "widget. You can find out what button by calling Fl::event_button()."]
#[doc = "You find out the mouse position by calling Fl::event_x() and"]
#[doc = "Fl::event_y()."]
#[doc = ""]
#[doc = "A widget indicates that it \"wants\" the mouse click by returning non-zero"]
#[doc = "from its Fl_Widget::handle() method. It will then become the"]
#[doc = "Fl::pushed() widget and will get FL_DRAG and the matching FL_RELEASE events."]
#[doc = "If Fl_Widget::handle() returns zero then FLTK will try sending the FL_PUSH"]
#[doc = "to another widget."]
pub const Fl_Event_FL_PUSH: Fl_Event = 1;
#[doc = " A mouse button has been released. You can find out what button by"]
#[doc = "calling Fl::event_button()."]
#[doc = ""]
#[doc = "In order to receive the FL_RELEASE event, the widget must return"]
#[doc = "non-zero when handling FL_PUSH."]
pub const Fl_Event_FL_RELEASE: Fl_Event = 2;
#[doc = " The mouse has been moved to point at this widget.  This can"]
#[doc = "be used for highlighting feedback.  If a widget wants to"]
#[doc = "highlight or otherwise track the mouse, it indicates this by"]
#[doc = "returning non-zero from its handle() method. It then"]
#[doc = "becomes the Fl::belowmouse() widget and will receive"]
#[doc = "FL_MOVE and FL_LEAVE events."]
pub const Fl_Event_FL_ENTER: Fl_Event = 3;
#[doc = " The mouse has moved out of the widget."]
#[doc = "In order to receive the FL_LEAVE event, the widget must"]
#[doc = "return non-zero when handling FL_ENTER."]
pub const Fl_Event_FL_LEAVE: Fl_Event = 4;
#[doc = " The mouse has moved with a button held down. The current button state"]
#[doc = "is in Fl::event_state(). The mouse position is in Fl::event_x() and"]
#[doc = "Fl::event_y()."]
#[doc = ""]
#[doc = "In order to receive FL_DRAG events, the widget must return non-zero"]
#[doc = "when handling FL_PUSH."]
pub const Fl_Event_FL_DRAG: Fl_Event = 5;
#[doc = " This indicates an <I>attempt</I> to give a widget the keyboard focus."]
#[doc = ""]
#[doc = "If a widget wants the focus, it should change itself to display the"]
#[doc = "fact that it has the focus, and return non-zero from its handle() method."]
#[doc = "It then becomes the Fl::focus() widget and gets FL_KEYDOWN, FL_KEYUP,"]
#[doc = "and FL_UNFOCUS events."]
#[doc = ""]
#[doc = "The focus will change either because the window manager changed which"]
#[doc = "window gets the focus, or because the user tried to navigate using tab,"]
#[doc = "arrows, or other keys. You can check Fl::event_key() to figure out why"]
#[doc = "it moved. For navigation it will be the key pressed and for interaction"]
#[doc = "with the window manager it will be zero."]
pub const Fl_Event_FL_FOCUS: Fl_Event = 6;
#[doc = " This event is sent to the previous Fl::focus() widget when another"]
#[doc = "widget gets the focus or the window loses focus."]
pub const Fl_Event_FL_UNFOCUS: Fl_Event = 7;
#[doc = " A key was pressed (FL_KEYDOWN) or released (FL_KEYUP)."]
#[doc = "Fl_KEYBOARD is a synonym for FL_KEYDOWN."]
#[doc = "The key can be found in Fl::event_key()."]
#[doc = "The text that the key should insert can be found with Fl::event_text()"]
#[doc = "and its length is in Fl::event_length(). If you use the key handle()"]
#[doc = "should return 1. If you return zero then FLTK assumes you ignored the"]
#[doc = "key and will then attempt to send it to a parent widget. If none of"]
#[doc = "them want it, it will change the event into a FL_SHORTCUT event."]
#[doc = ""]
#[doc = "To receive FL_KEYBOARD events you must also respond to the FL_FOCUS"]
#[doc = "and FL_UNFOCUS events."]
#[doc = ""]
#[doc = "If you are writing a text-editing widget you may also want to call"]
#[doc = "the Fl::compose() function to translate individual keystrokes into"]
#[doc = "non-ASCII characters."]
#[doc = ""]
#[doc = "FL_KEYUP events are sent to the widget that currently has focus. This"]
#[doc = "is not necessarily the same widget that received the corresponding"]
#[doc = "FL_KEYDOWN event because focus may have changed between events."]
pub const Fl_Event_FL_KEYDOWN: Fl_Event = 8;
#[doc = " Equivalent to FL_KEYDOWN."]
#[doc = "\\see FL_KEYDOWN"]
pub const Fl_Event_FL_KEYBOARD: Fl_Event = 8;
#[doc = " Key release event."]
#[doc = "\\see FL_KEYDOWN"]
pub const Fl_Event_FL_KEYUP: Fl_Event = 9;
#[doc = " The user clicked the close button of a window."]
#[doc = "This event is used internally only to trigger the callback of"]
#[doc = "Fl_Window derived classed. The default callback closes the"]
#[doc = "window calling Fl_Window::hide()."]
pub const Fl_Event_FL_CLOSE: Fl_Event = 10;
#[doc = " The mouse has moved without any mouse buttons held down."]
#[doc = "This event is sent to the Fl::belowmouse() widget."]
#[doc = ""]
#[doc = "In order to receive FL_MOVE events, the widget must return"]
#[doc = "non-zero when handling FL_ENTER."]
pub const Fl_Event_FL_MOVE: Fl_Event = 11;
#[doc = " If the Fl::focus() widget is zero or ignores an FL_KEYBOARD"]
#[doc = "event then FLTK tries sending this event to every widget it"]
#[doc = "can, until one of them returns non-zero. FL_SHORTCUT is first"]
#[doc = "sent to the Fl::belowmouse() widget, then its parents and siblings,"]
#[doc = "and eventually to every widget in the window, trying to find an"]
#[doc = "object that returns non-zero. FLTK tries really hard to not to ignore"]
#[doc = "any keystrokes!"]
#[doc = ""]
#[doc = "You can also make \"global\" shortcuts by using Fl::add_handler(). A"]
#[doc = "global shortcut will work no matter what windows are displayed or"]
#[doc = "which one has the focus."]
pub const Fl_Event_FL_SHORTCUT: Fl_Event = 12;
#[doc = " This widget is no longer active, due to Fl_Widget::deactivate()"]
#[doc = "being called on it or one of its parents. Fl_Widget::active() may"]
#[doc = "still be true after this, the widget is only active if Fl_Widget::active()"]
#[doc = "is true on it and all its parents (use Fl_Widget::active_r() to check this)."]
pub const Fl_Event_FL_DEACTIVATE: Fl_Event = 13;
#[doc = " This widget is now active, due to Fl_Widget::activate() being"]
#[doc = "called on it or one of its parents."]
pub const Fl_Event_FL_ACTIVATE: Fl_Event = 14;
#[doc = " This widget is no longer visible, due to Fl_Widget::hide() being"]
#[doc = "called on it or one of its parents, or due to a parent window being"]
#[doc = "minimized.  Fl_Widget::visible() may still be true after this, but the"]
#[doc = "widget is visible only if visible() is true for it and all its"]
#[doc = "parents (use Fl_Widget::visible_r() to check this)."]
pub const Fl_Event_FL_HIDE: Fl_Event = 15;
#[doc = " This widget is visible again, due to Fl_Widget::show() being called on"]
#[doc = "it or one of its parents, or due to a parent window being restored."]
#[doc = "Child Fl_Windows respond to this by actually creating the window if not"]
#[doc = "done already, so if you subclass a window, be sure to pass FL_SHOW"]
#[doc = "to the base class Fl_Widget::handle() method!"]
pub const Fl_Event_FL_SHOW: Fl_Event = 16;
#[doc = " You should get this event some time after you call Fl::paste()."]
#[doc = "The contents of Fl::event_text() is the text to insert and the number"]
#[doc = "of characters is in Fl::event_length()."]
pub const Fl_Event_FL_PASTE: Fl_Event = 17;
#[doc = " The Fl::selection_owner() will get this event before the selection is"]
#[doc = "moved to another widget. This indicates that some other widget or program"]
#[doc = "has claimed the selection. Motif programs used this to clear the selection"]
#[doc = "indication. Most modern programs ignore this."]
pub const Fl_Event_FL_SELECTIONCLEAR: Fl_Event = 18;
#[doc = " The user has moved the mouse wheel. The Fl::event_dx() and Fl::event_dy()"]
#[doc = "methods can be used to find the amount to scroll horizontally and vertically."]
pub const Fl_Event_FL_MOUSEWHEEL: Fl_Event = 19;
#[doc = " The mouse has been moved to point at this widget. A widget that is"]
#[doc = "interested in receiving drag'n'drop data must return 1 to receive"]
#[doc = "FL_DND_DRAG, FL_DND_LEAVE and FL_DND_RELEASE events."]
pub const Fl_Event_FL_DND_ENTER: Fl_Event = 20;
#[doc = " The mouse has been moved inside a widget while dragging data.  A"]
#[doc = "widget that is interested in receiving drag'n'drop data should"]
#[doc = "indicate the possible drop position."]
pub const Fl_Event_FL_DND_DRAG: Fl_Event = 21;
#[doc = " The mouse has moved out of the widget."]
pub const Fl_Event_FL_DND_LEAVE: Fl_Event = 22;
#[doc = " The user has released the mouse button dropping data into the widget."]
#[doc = "If the widget returns 1, it will receive the data in the immediately"]
#[doc = "following FL_PASTE event."]
pub const Fl_Event_FL_DND_RELEASE: Fl_Event = 23;
#[doc = " The screen configuration (number, positions) was changed."]
#[doc = "Use Fl::add_handler() to be notified of this event."]
pub const Fl_Event_FL_SCREEN_CONFIGURATION_CHANGED: Fl_Event = 24;
#[doc = " The fullscreen state of the window has changed."]
#[doc = "This event is sent to the window's handle method."]
pub const Fl_Event_FL_FULLSCREEN: Fl_Event = 25;
#[doc = " The user has made a zoom/pinch/magnification gesture (Mac OS platform only)."]
#[doc = "The Fl::event_dy() method can be used to find magnification amount,"]
#[doc = "Fl::event_x() and Fl::event_y() are set as well."]
#[doc = "This event is sent to the window's handle method."]
pub const Fl_Event_FL_ZOOM_GESTURE: Fl_Event = 26;
#[doc = " A zoom event (ctrl/+/-/0/ or cmd/+/-/0/) was processed."]
#[doc = "Use Fl::add_handler() to be notified of this event."]
pub const Fl_Event_FL_ZOOM_EVENT: Fl_Event = 27;
#[doc = "Every time a user moves the mouse pointer, clicks a button,"]
#[doc = "or presses a key, an event is generated and sent to your"]
#[doc = "application. Events can also come from other programs like the"]
#[doc = "window manager."]
#[doc = ""]
#[doc = "Events are identified by the integer argument passed to the"]
#[doc = "Fl_Widget::handle() virtual method. Other information about the"]
#[doc = "most recent event is stored in static locations and acquired  by"]
#[doc = "calling the Fl::event_*() methods. This static information remains"]
#[doc = "valid until the next event is read from the window system, so it"]
#[doc = "is ok to look at it outside of the handle() method."]
#[doc = ""]
#[doc = "Event numbers can be converted to their actual names using the"]
#[doc = "\\ref fl_eventnames[] array defined in \\#include &lt;FL/names.h&gt;"]
#[doc = ""]
#[doc = "\\see Fl::event_text(), Fl::event_key(), class Fl::"]
pub type Fl_Event = u32;
#[doc = "< Never call the callback"]
pub const Fl_When_FL_WHEN_NEVER: Fl_When = 0;
#[doc = "< Do the callback only when the widget value changes"]
pub const Fl_When_FL_WHEN_CHANGED: Fl_When = 1;
#[doc = "< Do the callback whenever the user interacts with the widget"]
pub const Fl_When_FL_WHEN_NOT_CHANGED: Fl_When = 2;
#[doc = "< Do the callback when the button or key is released and the value changes"]
pub const Fl_When_FL_WHEN_RELEASE: Fl_When = 4;
#[doc = "< Do the callback when the button or key is released, even if the value doesn't change"]
pub const Fl_When_FL_WHEN_RELEASE_ALWAYS: Fl_When = 6;
#[doc = "< Do the callback when the user presses the ENTER key and the value changes"]
pub const Fl_When_FL_WHEN_ENTER_KEY: Fl_When = 8;
#[doc = "< Do the callback when the user presses the ENTER key, even if the value doesn't change"]
pub const Fl_When_FL_WHEN_ENTER_KEY_ALWAYS: Fl_When = 10;
#[doc = "< ?"]
pub const Fl_When_FL_WHEN_ENTER_KEY_CHANGED: Fl_When = 11;
#[doc = " These constants determine when a callback is performed."]
#[doc = ""]
#[doc = "\\see Fl_Widget::when();"]
#[doc = "\\todo doxygen comments for values are incomplete and maybe wrong or unclear"]
pub type Fl_When = u32;
#[doc = "< nothing is drawn at all, this box is invisible"]
pub const Fl_Boxtype_FL_NO_BOX: Fl_Boxtype = 0;
#[doc = "< a flat box"]
pub const Fl_Boxtype_FL_FLAT_BOX: Fl_Boxtype = 1;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_UP_BOX: Fl_Boxtype = 2;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_DOWN_BOX: Fl_Boxtype = 3;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_UP_FRAME: Fl_Boxtype = 4;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_DOWN_FRAME: Fl_Boxtype = 5;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_THIN_UP_BOX: Fl_Boxtype = 6;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_THIN_DOWN_BOX: Fl_Boxtype = 7;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_THIN_UP_FRAME: Fl_Boxtype = 8;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_THIN_DOWN_FRAME: Fl_Boxtype = 9;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_ENGRAVED_BOX: Fl_Boxtype = 10;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_EMBOSSED_BOX: Fl_Boxtype = 11;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_ENGRAVED_FRAME: Fl_Boxtype = 12;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_EMBOSSED_FRAME: Fl_Boxtype = 13;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_BORDER_BOX: Fl_Boxtype = 14;
#[doc = "< see figure 1, use FL_SHADOW_BOX"]
pub const Fl_Boxtype__FL_SHADOW_BOX: Fl_Boxtype = 15;
#[doc = "< see figure 1"]
pub const Fl_Boxtype_FL_BORDER_FRAME: Fl_Boxtype = 16;
#[doc = "< see figure 1, use FL_SHADOW_FRAME"]
pub const Fl_Boxtype__FL_SHADOW_FRAME: Fl_Boxtype = 17;
#[doc = "< see figure 1, use FL_ROUNDED_BOX"]
pub const Fl_Boxtype__FL_ROUNDED_BOX: Fl_Boxtype = 18;
#[doc = "< see figure 1, use FL_RSHADOW_BOX"]
pub const Fl_Boxtype__FL_RSHADOW_BOX: Fl_Boxtype = 19;
#[doc = "< see figure 1, use FL_ROUNDED_FRAME"]
pub const Fl_Boxtype__FL_ROUNDED_FRAME: Fl_Boxtype = 20;
#[doc = "< see figure 1, use FL_RFLAT_BOX"]
pub const Fl_Boxtype__FL_RFLAT_BOX: Fl_Boxtype = 21;
#[doc = "< see figure 1, use FL_ROUND_UP_BOX"]
pub const Fl_Boxtype__FL_ROUND_UP_BOX: Fl_Boxtype = 22;
#[doc = "< see figure 1, use FL_ROUND_DOWN_BOX"]
pub const Fl_Boxtype__FL_ROUND_DOWN_BOX: Fl_Boxtype = 23;
#[doc = "< see figure 1, use FL_DIAMOND_UP_BOX"]
pub const Fl_Boxtype__FL_DIAMOND_UP_BOX: Fl_Boxtype = 24;
#[doc = "< see figure 1, use FL_DIAMOND_DOWN_BOX"]
pub const Fl_Boxtype__FL_DIAMOND_DOWN_BOX: Fl_Boxtype = 25;
#[doc = "< see figure 1, use FL_OVAL_BOX"]
pub const Fl_Boxtype__FL_OVAL_BOX: Fl_Boxtype = 26;
#[doc = "< see figure 1, use FL_OSHADOW_BOX"]
pub const Fl_Boxtype__FL_OSHADOW_BOX: Fl_Boxtype = 27;
#[doc = "< see figure 1, use FL_OVAL_FRAME"]
pub const Fl_Boxtype__FL_OVAL_FRAME: Fl_Boxtype = 28;
#[doc = "< see figure 1, use FL_OFLAT_BOX"]
pub const Fl_Boxtype__FL_OFLAT_BOX: Fl_Boxtype = 29;
#[doc = "< plastic version of FL_UP_BOX, use FL_PLASTIC_UP_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_UP_BOX: Fl_Boxtype = 30;
#[doc = "< plastic version of FL_DOWN_BOX, use FL_PLASTIC_DOWN_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_DOWN_BOX: Fl_Boxtype = 31;
#[doc = "< plastic version of FL_UP_FRAME, use FL_PLASTIC_UP_FRAME"]
pub const Fl_Boxtype__FL_PLASTIC_UP_FRAME: Fl_Boxtype = 32;
#[doc = "< plastic version of FL_DOWN_FRAME, use FL_PLASTIC_DOWN_FRAME"]
pub const Fl_Boxtype__FL_PLASTIC_DOWN_FRAME: Fl_Boxtype = 33;
#[doc = "< plastic version of FL_THIN_UP_BOX, use FL_PLASTIC_THIN_UP_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_THIN_UP_BOX: Fl_Boxtype = 34;
#[doc = "< plastic version of FL_THIN_DOWN_BOX, use FL_PLASTIC_THIN_DOWN_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_THIN_DOWN_BOX: Fl_Boxtype = 35;
#[doc = "< plastic version of FL_ROUND_UP_BOX, use FL_PLASTIC_ROUND_UP_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_ROUND_UP_BOX: Fl_Boxtype = 36;
#[doc = "< plastic version of FL_ROUND_DOWN_BOX, use FL_PLASTIC_ROUND_DOWN_BOX"]
pub const Fl_Boxtype__FL_PLASTIC_ROUND_DOWN_BOX: Fl_Boxtype = 37;
#[doc = "< gtk+ version of FL_UP_BOX, use FL_GTK_UP_BOX"]
pub const Fl_Boxtype__FL_GTK_UP_BOX: Fl_Boxtype = 38;
#[doc = "< gtk+ version of FL_DOWN_BOX, use FL_GTK_DOWN_BOX"]
pub const Fl_Boxtype__FL_GTK_DOWN_BOX: Fl_Boxtype = 39;
#[doc = "< gtk+ version of FL_UP_FRAME, use FL_GTK_UP_FRAME"]
pub const Fl_Boxtype__FL_GTK_UP_FRAME: Fl_Boxtype = 40;
#[doc = "< gtk+ version of FL_DOWN_FRAME, use FL_GTK_DOWN_FRAME"]
pub const Fl_Boxtype__FL_GTK_DOWN_FRAME: Fl_Boxtype = 41;
#[doc = "< gtk+ version of FL_THIN_UP_BOX, use FL_GTK_THIN_UP_BOX"]
pub const Fl_Boxtype__FL_GTK_THIN_UP_BOX: Fl_Boxtype = 42;
#[doc = "< gtk+ version of FL_THIN_DOWN_BOX, use FL_GTK_THIN_DOWN_BOX"]
pub const Fl_Boxtype__FL_GTK_THIN_DOWN_BOX: Fl_Boxtype = 43;
#[doc = "< gtk+ version of FL_THIN_UP_FRAME, use FL_GTK_THIN_UP_FRAME"]
pub const Fl_Boxtype__FL_GTK_THIN_UP_FRAME: Fl_Boxtype = 44;
#[doc = "< gtk+ version of FL_THIN_DOWN_FRAME, use FL_GTK_THIN_DOWN_FRAME"]
pub const Fl_Boxtype__FL_GTK_THIN_DOWN_FRAME: Fl_Boxtype = 45;
#[doc = "< gtk+ version of FL_ROUND_UP_BOX, use FL_GTK_ROUND_UP_BOX"]
pub const Fl_Boxtype__FL_GTK_ROUND_UP_BOX: Fl_Boxtype = 46;
#[doc = "< gtk+ version of FL_ROUND_DOWN_BOX, use FL_GTK_ROUND_DOWN_BOX"]
pub const Fl_Boxtype__FL_GTK_ROUND_DOWN_BOX: Fl_Boxtype = 47;
#[doc = "< gleam version of FL_UP_BOX, use FL_GLEAM_UP_BOX"]
pub const Fl_Boxtype__FL_GLEAM_UP_BOX: Fl_Boxtype = 48;
#[doc = "< gleam version of FL_DOWN_BOX, use FL_GLEAM_DOWN_BOX"]
pub const Fl_Boxtype__FL_GLEAM_DOWN_BOX: Fl_Boxtype = 49;
#[doc = "< gleam version of FL_UP_FRAME, use FL_GLEAM_UP_FRAME"]
pub const Fl_Boxtype__FL_GLEAM_UP_FRAME: Fl_Boxtype = 50;
#[doc = "< gleam version of FL_DOWN_FRAME, use FL_GLEAM_DOWN_FRAME"]
pub const Fl_Boxtype__FL_GLEAM_DOWN_FRAME: Fl_Boxtype = 51;
#[doc = "< gleam version of FL_THIN_UP_BOX, use FL_GLEAM_THIN_UP_BOX"]
pub const Fl_Boxtype__FL_GLEAM_THIN_UP_BOX: Fl_Boxtype = 52;
#[doc = "< gleam version of FL_THIN_DOWN_BOX, use FL_GLEAM_THIN_DOWN_BOX"]
pub const Fl_Boxtype__FL_GLEAM_THIN_DOWN_BOX: Fl_Boxtype = 53;
#[doc = "< gleam version of FL_ROUND_UP_BOX, use FL_GLEAM_ROUND_UP_BOX"]
pub const Fl_Boxtype__FL_GLEAM_ROUND_UP_BOX: Fl_Boxtype = 54;
#[doc = "< gleam version of FL_ROUND_DOWN_BOX, use FL_GLEAM_ROUND_DOWN_BOX"]
pub const Fl_Boxtype__FL_GLEAM_ROUND_DOWN_BOX: Fl_Boxtype = 55;
#[doc = "< the first free box type for creation of new box types"]
pub const Fl_Boxtype_FL_FREE_BOXTYPE: Fl_Boxtype = 56;
#[doc = "\\brief FLTK standard box types"]
#[doc = ""]
#[doc = "This enum defines the standard box types included with FLTK."]
#[doc = ""]
#[doc = "\\note The documented \\p enum \\p Fl_Boxtype contains some values (names)"]
#[doc = "with leading underscores, e.g. \\p \\b _FL_SHADOW_BOX. This is due to"]
#[doc = "technical reasons - please use the same values (names) without the"]
#[doc = "leading underscore in your code! Enum values with leading underscores"]
#[doc = "are reserved for internal use and subject to change without notice!"]
pub type Fl_Boxtype = u32;
extern "C" {
    #[link_name = "\u{1}_Z25fl_define_FL_ROUND_UP_BOXv"]
    pub fn fl_define_FL_ROUND_UP_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z23fl_define_FL_SHADOW_BOXv"]
    pub fn fl_define_FL_SHADOW_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z24fl_define_FL_ROUNDED_BOXv"]
    pub fn fl_define_FL_ROUNDED_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z22fl_define_FL_RFLAT_BOXv"]
    pub fn fl_define_FL_RFLAT_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z24fl_define_FL_RSHADOW_BOXv"]
    pub fn fl_define_FL_RSHADOW_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z24fl_define_FL_DIAMOND_BOXv"]
    pub fn fl_define_FL_DIAMOND_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z21fl_define_FL_OVAL_BOXv"]
    pub fn fl_define_FL_OVAL_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z27fl_define_FL_PLASTIC_UP_BOXv"]
    pub fn fl_define_FL_PLASTIC_UP_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z23fl_define_FL_GTK_UP_BOXv"]
    pub fn fl_define_FL_GTK_UP_BOX() -> Fl_Boxtype;
}
extern "C" {
    #[link_name = "\u{1}_Z25fl_define_FL_GLEAM_UP_BOXv"]
    pub fn fl_define_FL_GLEAM_UP_BOX() -> Fl_Boxtype;
}
#[doc = "< draws the text (0)"]
pub const Fl_Labeltype_FL_NORMAL_LABEL: Fl_Labeltype = 0;
#[doc = "< does nothing"]
pub const Fl_Labeltype_FL_NO_LABEL: Fl_Labeltype = 1;
#[doc = "< draws a drop shadow under the text"]
pub const Fl_Labeltype__FL_SHADOW_LABEL: Fl_Labeltype = 2;
#[doc = "< draws edges as though the text is engraved"]
pub const Fl_Labeltype__FL_ENGRAVED_LABEL: Fl_Labeltype = 3;
#[doc = "< draws edges as though the text is raised"]
pub const Fl_Labeltype__FL_EMBOSSED_LABEL: Fl_Labeltype = 4;
#[doc = "< draws a composite label \\see Fl_Multi_Label"]
pub const Fl_Labeltype__FL_MULTI_LABEL: Fl_Labeltype = 5;
#[doc = "< draws the icon associated with the text"]
pub const Fl_Labeltype__FL_ICON_LABEL: Fl_Labeltype = 6;
#[doc = "< the label displays an \"icon\" based on a Fl_Image"]
pub const Fl_Labeltype__FL_IMAGE_LABEL: Fl_Labeltype = 7;
#[doc = "< first free labeltype to use for creating own labeltypes"]
pub const Fl_Labeltype_FL_FREE_LABELTYPE: Fl_Labeltype = 8;
#[doc = "The labeltype() method sets the type of the label."]
#[doc = ""]
#[doc = "\\note The documented \\p enum \\p Fl_Labeltype contains some values (names)"]
#[doc = "with leading underscores, e.g. \\p \\b _FL_IMAGE_LABEL. This is due to"]
#[doc = "technical reasons - please use the same values (names) without the"]
#[doc = "leading underscore in your code! Enum values with leading underscores"]
#[doc = "are reserved for internal use and subject to change without notice!"]
#[doc = ""]
#[doc = "The following standard label types are included:"]
pub type Fl_Labeltype = u32;
extern "C" {
    #[doc = "Initializes the internal table entry for FL_SHADOW_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z25fl_define_FL_SHADOW_LABELv"]
    pub fn fl_define_FL_SHADOW_LABEL() -> Fl_Labeltype;
}
extern "C" {
    #[doc = "Initializes the internal table entry for FL_ENGRAVED_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z27fl_define_FL_ENGRAVED_LABELv"]
    pub fn fl_define_FL_ENGRAVED_LABEL() -> Fl_Labeltype;
}
extern "C" {
    #[doc = "Initializes the internal table entry for FL_EMBOSSED_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z27fl_define_FL_EMBOSSED_LABELv"]
    pub fn fl_define_FL_EMBOSSED_LABEL() -> Fl_Labeltype;
}
extern "C" {
    #[doc = "Initializes the internal table entry for FL_MULTI_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z24fl_define_FL_MULTI_LABELv"]
    pub fn fl_define_FL_MULTI_LABEL() -> Fl_Labeltype;
}
extern "C" {
    #[doc = "Initializes the internal table entry for FL_ICON_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z23fl_define_FL_ICON_LABELv"]
    pub fn fl_define_FL_ICON_LABEL() -> Fl_Labeltype;
}
extern "C" {
    #[doc = "Initializes the internal table entry for FL_IMAGE_LABEL and returns"]
    #[doc = "its internal value. Internal use only."]
    #[link_name = "\u{1}_Z24fl_define_FL_IMAGE_LABELv"]
    pub fn fl_define_FL_IMAGE_LABEL() -> Fl_Labeltype;
}
#[doc = " FLTK type for alignment control."]
pub type Fl_Align = ::std::os::raw::c_uint;
pub const FL_ALIGN_CENTER: Fl_Align = 0;
pub const FL_ALIGN_TOP: Fl_Align = 1;
pub const FL_ALIGN_BOTTOM: Fl_Align = 2;
pub const FL_ALIGN_LEFT: Fl_Align = 4;
pub const FL_ALIGN_RIGHT: Fl_Align = 8;
pub const FL_ALIGN_INSIDE: Fl_Align = 16;
pub const FL_ALIGN_TEXT_OVER_IMAGE: Fl_Align = 32;
pub const FL_ALIGN_IMAGE_OVER_TEXT: Fl_Align = 0;
pub const FL_ALIGN_CLIP: Fl_Align = 64;
pub const FL_ALIGN_WRAP: Fl_Align = 128;
pub const FL_ALIGN_IMAGE_NEXT_TO_TEXT: Fl_Align = 256;
pub const FL_ALIGN_TEXT_NEXT_TO_IMAGE: Fl_Align = 288;
pub const FL_ALIGN_IMAGE_BACKDROP: Fl_Align = 512;
pub const FL_ALIGN_TOP_LEFT: Fl_Align = 5;
pub const FL_ALIGN_TOP_RIGHT: Fl_Align = 9;
pub const FL_ALIGN_BOTTOM_LEFT: Fl_Align = 6;
pub const FL_ALIGN_BOTTOM_RIGHT: Fl_Align = 10;
pub const FL_ALIGN_LEFT_TOP: Fl_Align = 7;
pub const FL_ALIGN_RIGHT_TOP: Fl_Align = 11;
pub const FL_ALIGN_LEFT_BOTTOM: Fl_Align = 13;
pub const FL_ALIGN_RIGHT_BOTTOM: Fl_Align = 14;
pub const FL_ALIGN_NOWRAP: Fl_Align = 0;
pub const FL_ALIGN_POSITION_MASK: Fl_Align = 15;
pub const FL_ALIGN_IMAGE_MASK: Fl_Align = 800;
#[doc = " A font number is an index into the internal font table."]
pub type Fl_Font = ::std::os::raw::c_int;
pub const FL_HELVETICA: Fl_Font = 0;
pub const FL_HELVETICA_BOLD: Fl_Font = 1;
pub const FL_HELVETICA_ITALIC: Fl_Font = 2;
pub const FL_HELVETICA_BOLD_ITALIC: Fl_Font = 3;
pub const FL_COURIER: Fl_Font = 4;
pub const FL_COURIER_BOLD: Fl_Font = 5;
pub const FL_COURIER_ITALIC: Fl_Font = 6;
pub const FL_COURIER_BOLD_ITALIC: Fl_Font = 7;
pub const FL_TIMES: Fl_Font = 8;
pub const FL_TIMES_BOLD: Fl_Font = 9;
pub const FL_TIMES_ITALIC: Fl_Font = 10;
pub const FL_TIMES_BOLD_ITALIC: Fl_Font = 11;
pub const FL_SYMBOL: Fl_Font = 12;
pub const FL_SCREEN: Fl_Font = 13;
pub const FL_SCREEN_BOLD: Fl_Font = 14;
pub const FL_ZAPF_DINGBATS: Fl_Font = 15;
pub const FL_FREE_FONT: Fl_Font = 16;
pub const FL_BOLD: Fl_Font = 1;
pub const FL_ITALIC: Fl_Font = 2;
pub const FL_BOLD_ITALIC: Fl_Font = 3;
#[doc = " Size of a font in pixels."]
#[doc = "This is the approximate height of a font in pixels."]
pub type Fl_Fontsize = ::std::os::raw::c_int;
extern "C" {
    pub static mut FL_NORMAL_SIZE: Fl_Fontsize;
}
#[doc = " An FLTK color value; see also \\ref drawing_colors"]
pub type Fl_Color = ::std::os::raw::c_uint;
pub const FL_FOREGROUND_COLOR: Fl_Color = 0;
pub const FL_BACKGROUND2_COLOR: Fl_Color = 7;
pub const FL_INACTIVE_COLOR: Fl_Color = 8;
pub const FL_SELECTION_COLOR: Fl_Color = 15;
pub const FL_GRAY0: Fl_Color = 32;
pub const FL_DARK3: Fl_Color = 39;
pub const FL_DARK2: Fl_Color = 45;
pub const FL_DARK1: Fl_Color = 47;
pub const FL_BACKGROUND_COLOR: Fl_Color = 49;
pub const FL_LIGHT1: Fl_Color = 50;
pub const FL_LIGHT2: Fl_Color = 52;
pub const FL_LIGHT3: Fl_Color = 54;
pub const FL_BLACK: Fl_Color = 56;
pub const FL_RED: Fl_Color = 88;
pub const FL_GREEN: Fl_Color = 63;
pub const FL_YELLOW: Fl_Color = 95;
pub const FL_BLUE: Fl_Color = 216;
pub const FL_MAGENTA: Fl_Color = 248;
pub const FL_CYAN: Fl_Color = 223;
pub const FL_DARK_RED: Fl_Color = 72;
pub const FL_DARK_GREEN: Fl_Color = 60;
pub const FL_DARK_YELLOW: Fl_Color = 76;
pub const FL_DARK_BLUE: Fl_Color = 136;
pub const FL_DARK_MAGENTA: Fl_Color = 152;
pub const FL_DARK_CYAN: Fl_Color = 140;
pub const FL_WHITE: Fl_Color = 255;
extern "C" {
    #[link_name = "\u{1}_Z11fl_inactivej"]
    pub fn fl_inactive(c: Fl_Color) -> Fl_Color;
}
extern "C" {
    #[link_name = "\u{1}_Z11fl_contrastjj"]
    pub fn fl_contrast(fg: Fl_Color, bg: Fl_Color) -> Fl_Color;
}
extern "C" {
    #[link_name = "\u{1}_Z16fl_color_averagejjf"]
    pub fn fl_color_average(c1: Fl_Color, c2: Fl_Color, weight: f32) -> Fl_Color;
}
#[doc = "< the default cursor, usually an arrow."]
pub const Fl_Cursor_FL_CURSOR_DEFAULT: Fl_Cursor = 0;
#[doc = "< an arrow pointer."]
pub const Fl_Cursor_FL_CURSOR_ARROW: Fl_Cursor = 35;
#[doc = "< crosshair."]
pub const Fl_Cursor_FL_CURSOR_CROSS: Fl_Cursor = 66;
#[doc = "< busy indicator (for instance hourglass)."]
pub const Fl_Cursor_FL_CURSOR_WAIT: Fl_Cursor = 76;
#[doc = "< I-beam."]
pub const Fl_Cursor_FL_CURSOR_INSERT: Fl_Cursor = 77;
#[doc = "< pointing hand."]
pub const Fl_Cursor_FL_CURSOR_HAND: Fl_Cursor = 31;
#[doc = "< question mark pointer."]
pub const Fl_Cursor_FL_CURSOR_HELP: Fl_Cursor = 47;
#[doc = "< 4-pointed arrow or hand."]
pub const Fl_Cursor_FL_CURSOR_MOVE: Fl_Cursor = 27;
#[doc = "< up/down resize."]
pub const Fl_Cursor_FL_CURSOR_NS: Fl_Cursor = 78;
#[doc = "< left/right resize."]
pub const Fl_Cursor_FL_CURSOR_WE: Fl_Cursor = 79;
#[doc = "< diagonal resize."]
pub const Fl_Cursor_FL_CURSOR_NWSE: Fl_Cursor = 80;
#[doc = "< diagonal resize."]
pub const Fl_Cursor_FL_CURSOR_NESW: Fl_Cursor = 81;
#[doc = "< upwards resize."]
pub const Fl_Cursor_FL_CURSOR_N: Fl_Cursor = 70;
#[doc = "< upwards, right resize."]
pub const Fl_Cursor_FL_CURSOR_NE: Fl_Cursor = 69;
#[doc = "< rightwards resize."]
pub const Fl_Cursor_FL_CURSOR_E: Fl_Cursor = 49;
#[doc = "< downwards, right resize."]
pub const Fl_Cursor_FL_CURSOR_SE: Fl_Cursor = 8;
#[doc = "< downwards resize."]
pub const Fl_Cursor_FL_CURSOR_S: Fl_Cursor = 9;
#[doc = "< downwards, left resize."]
pub const Fl_Cursor_FL_CURSOR_SW: Fl_Cursor = 7;
#[doc = "< leftwards resize."]
pub const Fl_Cursor_FL_CURSOR_W: Fl_Cursor = 36;
#[doc = "< upwards, left resize."]
pub const Fl_Cursor_FL_CURSOR_NW: Fl_Cursor = 68;
#[doc = "< invisible."]
pub const Fl_Cursor_FL_CURSOR_NONE: Fl_Cursor = 255;
#[doc = " The following constants define the mouse cursors that are available in FLTK."]
#[doc = ""]
#[doc = "Cursors are provided by the system when available, or bitmaps built into"]
#[doc = "FLTK as a fallback."]
#[doc = ""]
#[doc = "\\todo enum Fl_Cursor needs maybe an image."]
pub type Fl_Cursor = u32;
#[doc = "< Call the callback when there is data to be read."]
pub const FL_READ: _bindgen_ty_2 = 1;
#[doc = "< Call the callback when data can be written without blocking."]
pub const FL_WRITE: _bindgen_ty_2 = 4;
#[doc = "< Call the callback if an exception occurs on the file."]
pub const FL_EXCEPT: _bindgen_ty_2 = 8;
#[doc = " FD \"when\" conditions"]
pub type _bindgen_ty_2 = u32;
pub const Fl_Mode_FL_RGB: Fl_Mode = 0;
pub const Fl_Mode_FL_INDEX: Fl_Mode = 1;
pub const Fl_Mode_FL_SINGLE: Fl_Mode = 0;
pub const Fl_Mode_FL_DOUBLE: Fl_Mode = 2;
pub const Fl_Mode_FL_ACCUM: Fl_Mode = 4;
pub const Fl_Mode_FL_ALPHA: Fl_Mode = 8;
pub const Fl_Mode_FL_DEPTH: Fl_Mode = 16;
pub const Fl_Mode_FL_STENCIL: Fl_Mode = 32;
pub const Fl_Mode_FL_RGB8: Fl_Mode = 64;
pub const Fl_Mode_FL_MULTISAMPLE: Fl_Mode = 128;
pub const Fl_Mode_FL_STEREO: Fl_Mode = 256;
pub const Fl_Mode_FL_FAKE_SINGLE: Fl_Mode = 512;
pub const Fl_Mode_FL_OPENGL3: Fl_Mode = 1024;
#[doc = " visual types and Fl_Gl_Window::mode() (values match Glut)"]
pub type Fl_Mode = u32;
#[doc = "< A child needs to be redrawn."]
pub const Fl_Damage_FL_DAMAGE_CHILD: Fl_Damage = 1;
#[doc = "< The window was exposed."]
pub const Fl_Damage_FL_DAMAGE_EXPOSE: Fl_Damage = 2;
#[doc = "< The Fl_Scroll widget was scrolled."]
pub const Fl_Damage_FL_DAMAGE_SCROLL: Fl_Damage = 4;
#[doc = "< The overlay planes need to be redrawn."]
pub const Fl_Damage_FL_DAMAGE_OVERLAY: Fl_Damage = 8;
#[doc = "< First user-defined damage bit."]
pub const Fl_Damage_FL_DAMAGE_USER1: Fl_Damage = 16;
#[doc = "< Second user-defined damage bit."]
pub const Fl_Damage_FL_DAMAGE_USER2: Fl_Damage = 32;
#[doc = "< Everything needs to be redrawn."]
pub const Fl_Damage_FL_DAMAGE_ALL: Fl_Damage = 128;
#[doc = " Damage masks"]
pub type Fl_Damage = u32;
