...
extern "C" {
    pub fn Fl_Box_draw(self_: *mut Fl_Box, cb: custom_draw_callback, data: *mut core::ffi::c_void);
}
extern "C" {
...
extern "C" {
    pub fn Fl_Box_inside(self_: *const Fl_Box, arg1: *mut core::ffi::c_void) -> core::ffi::c_int;
}
extern "C" {
...
extern "C" {
    pub fn Fl_Box_set_callback(arg1: *mut Fl_Box, arg2: Fl_Callback, arg3: *mut core::ffi::c_void);
}
extern "C" {
