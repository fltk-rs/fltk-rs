...
extern "C" {
    pub fn Fl_message(x: core::ffi::c_int, y: core::ffi::c_int, txt: *const core::ffi::c_char);
}
extern "C" {
...
extern "C" {
    pub fn Fl_File_Chooser_showHiddenButton(self_: *mut Fl_File_Chooser) -> *mut core::ffi::c_void;
}
extern "C" {
...
extern "C" {
    pub fn Fl_File_Chooser_set_directory(self_: *mut Fl_File_Chooser, d: *const core::ffi::c_char);
}
extern "C" {
