...
extern "C" {
    pub fn Fl_Printer_set_origin(self_: *mut Fl_Printer, x: core::ffi::c_int, y: core::ffi::c_int);
}
extern "C" {
...
extern "C" {
    pub fn Fl_Printer_translate(self_: *mut Fl_Printer, x: core::ffi::c_int, y: core::ffi::c_int);
}
extern "C" {
