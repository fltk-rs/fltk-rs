    ...
    ($name: tt, $flname: tt) => {
        ...
        unsafe impl WindowExt for $name {
            ...
            fn make_modal(&mut self, val: bool) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _make_modal)(self.inner, val as u32) }
            }

            fn fullscreen(&mut self, val: bool) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _fullscreen)(self.inner, val as u32) }
            }

            fn make_current(&mut self) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _make_current)(self.inner) }
            }

            fn icon(&self) -> Option<Box<dyn ImageExt>> {
                unsafe {
                    assert!(!self.was_deleted());
                    let image_ptr = concat_idents!($flname, _icon)(self.inner);
            ...
            fn set_cursor(&mut self, cursor: Cursor) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _set_cursor)(self.inner, cursor as i32) }
            }

            fn shown(&self) -> bool {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _shown)(self.inner) != 0 }
            }

            fn set_border(&mut self, flag: bool) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _set_border)(self.inner, flag as i32) }
            }

            fn border(&self) -> bool {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _border)(self.inner) != 0 }
            }

            fn free_position(&mut self) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _free_position)(self.inner) }
            }

            fn raw_handle(&self) -> RawHandle {
                assert!(!self.was_deleted());
                unsafe {
                    let ptr = concat_idents!($flname, _raw_handle)(self.inner);
                    assert!(!ptr.is_null());
            ...
            fn region(&self) -> crate::draw::Region {
                assert!(!self.was_deleted());
                unsafe {
                    let ptr = concat_idents!($flname, _region)(self.inner);
                    assert!(!ptr.is_null());
                    ptr
                }
            }
            ...
            unsafe fn set_region(&mut self, region: crate::draw::Region) {
                ...
                concat_idents!($flname, _set_region)(self.inner, region)
            }

            fn iconize(&mut self) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _iconize)(self.inner) }
            }

            fn fullscreen_active(&self) -> bool {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _fullscreen_active)(self.inner) != 0 }
            }

            fn decorated_w(&self) -> i32 {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _decorated_w)(self.inner) }
            }

            fn decorated_h(&self) -> i32 {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _decorated_h)(self.inner) }
            }

            fn size_range(&mut self, min_w: i32, min_h: i32, max_w: i32, max_h: i32) {
                assert!(!self.was_deleted());
                unsafe {
                    concat_idents!($flname, _size_range)(self.inner, min_w, min_h, max_w, max_h);
                }
            }
            ...
            fn hotspot<W: WidgetExt>(&mut self, w: &W) {
                ...
                unsafe { concat_idents!($flname, _hotspot)(self.inner, w.as_widget_ptr() as _) }
            }
            ...
            fn set_shape<I: ImageExt>(&mut self, image: Option<I>) {
                ...
                unsafe {
                    if let Some(image) = image {
                        ...
                        concat_idents!($flname, _set_shape)(self.inner, image.as_image_ptr() as _)
                    };
                }
            }
            ...
            fn shape(&self) -> Option<Box<dyn ImageExt>> {
                assert!(!self.was_deleted());
                unsafe {
                    let image_ptr = concat_idents!($flname, _shape)(self.inner);
                    if image_ptr.is_null() {
                        None
                    } else {
                        let mut img =
            ...
            fn x_root(&self) -> i32 {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _x_root)(self.inner) }
            }

            fn y_root(&self) -> i32 {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _y_root)(self.inner) }
            }
            ...
            fn set_cursor_image(
                ...
                unsafe {
                    assert!(!image.was_deleted());
                    image.increment_arc();
                    concat_idents!($flname, _set_cursor_image)(
                        self.inner,
            ...
            fn default_cursor(&mut self, cursor: Cursor) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _default_cursor)(self.inner, cursor as i32) }
            }

            fn screen_num(&self) -> i32 {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _screen_num)(self.inner) }
            }

            fn set_screen_num(&mut self, n: i32) {
                assert!(!self.was_deleted());
                unsafe { concat_idents!($flname, _set_screen_num)(self.inner, n) }
            }
        }
    };
}
